console.warn("[sonic] loaded /js/youtube/youtube.js, v2");
////////////////////////////////////////////////////////////////////////
  ...
  function loopWithInterval() {
    ...
    for (var i = 0; i < rowsLength; i++) {
      ...
      if ( clearBtn && channelName ) {
        if ( arrayContains(channelName, channelsArray) || channelName.match(/(20th ?Century ?Fox|Netflix|Nintendo|Playstation|Xbox|VEVO)/gi) || videoName.match(/(Pokemon|Nintendo Switch|DBZ|Dragon Ball|4XM|World of Warcraft|Trailers?|Super Smash|Smash Brothers|SSBM|Project M|Zelda|Overwatch|Super Mario|Hearthstone)/gi) ) {
          clearBtn.click();
          deleteCount++;
